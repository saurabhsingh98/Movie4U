...
const MovieCard = ({ movie }) => {
    // default poster
    const defaultPoster = "https://m.media-amazon.com/images/M/MV5BYTdkMDA4NjEtZTJjNi00MTljLTgwNjEtMzA1ODg2NTRjZmE3XkEyXkFqcGdeQXVyNjUyNTE0NTY@._V1_SX300.jpg"
    if(movie.Poster === "N/A") {
    ...
    return (
        <div className='bg-gray-800 rounded-xl overflow-hidden shadow-lg transform transition duration-300 hover:scale-105 hover:shadow-2xl'>
            <div className='h-48 bg-gradient-to-r from-purple-500 to-pink-500' style={{ backgroundImage: `url(${movie.Poster || defaultPoster})` }}></div>
            <div className='p-6'>
